    ...
    <section className="relative bg-gradient-to-r from-gray-100 to-gray-300 text-gray-900 p-6 md:p-12 lg:p-20 flex items-center justify-center min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="relative w-full h-full">
          ...
          {/* Purple Particle */}
          <motion.div
            className="absolute w-20 h-20 md:w-28 md:h-28 lg:w-40 lg:h-40 bg-purple-500 opacity-20 rounded-full"
            animate={{ scale: [1, 1.2, 1], opacity: [0.5, 0.2, 0.5] }}
            transition={{ duration: 9, repeat: Infinity, ease: 'easeInOut' }}
            style={{ top: '50%', right: '27%' }}
          >
            <img src={purpleParticle} alt="Purple Particle" className="w-full h-full rounded-full opacity-30" />
          </motion.div>
          {/* Green Particle */}
          <motion.div
            className="absolute w-24 h-24 md:w-32 md:h-32 lg:w-48 lg:h-48 bg-green-400 opacity-20 rounded-full"
      ...
      >
        ...
        <p className="mt-2 md:mt-4 text-lg md:text-2xl mb-7">A passionate Web Developer</p>
        <motion.a
          href="#projects"

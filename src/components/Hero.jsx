    ...
    <section className="relative bg-gradient-to-r from-gray-100 to-gray-300 text-gray-900 flex items-center justify-center min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="relative w-full h-full">
          {/* Blue Particle */}
          <motion.div
            className="absolute w-24 h-24 md:w-32 md:h-32 lg:w-48 lg:h-48 bg-blue-400 opacity-20 rounded-full animate-spin"
          ...
          {/* Purple Particle */}
          <motion.div
            className="absolute w-28 h-28 md:w-28 md:h-28 lg:w-40 lg:h-40 bg-purple-500 opacity-20 rounded-full animate-spin"
          ...
          {/* Green Particle */}
          <motion.div
            className="absolute w-32 h-32 md:w-32 md:h-32 lg:w-48 lg:h-48 bg-green-400 opacity-20 rounded-full animate-spin"
      ...
      >
        ...
        <div className='animate-bounce pt-3'>
          <button>
            <motion.a
              href="#projects"
